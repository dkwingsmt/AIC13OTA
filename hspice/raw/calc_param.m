...
% TODO: plug in ln
idw12=myinterp2(gmid_idw_gmidn, gmid_idw_ln, ...
    gmid_idw_idwn, gmid1, ln);
w12=id12/idw12;
...
idw1a=myinterp2(gmid_idw_gmidn, gmid_idw_ln, ...
    gmid_idw_idwn, gmid1a, ln);
...
idw3=myinterp2(gmid_idw_gmidp, gmid_idw_lp, ...
    gmid_idw_idwp, gmid3, l3);
...
gmid0=gmid3;
idw0=myinterp2(gmid_idw_gmidn, gmid_idw_ln, ...
    gmid_idw_idwn, gmid0, ln);
w0=id0/idw0;
wb=w0/k_0_b;
w7c=wb*k_7_b;
w5c=wb*k_5_b;

w5b=w3*k_5_b/k_1_b;       % I3 = I1
w7a=w3*k_7_b/k_1_b;
w6a=w3*k_6_1;
w3a=w3;
w4a=w3;
...
w7b=w7a;
w6b=w6a;
w6c=w1a*k_6_1*0.8;      % Reasonless ratio
w6d=w6c/5;
ib=id0/k_0_b;
